 ...
 */
final class Version20241205134252 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photo ADD animal_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_14B784188E962C16 ON photo');
        $this->addSql('ALTER TABLE photo DROP animal_id');
    }
}
